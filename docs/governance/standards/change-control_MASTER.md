...
1. **Classify**: choose the single intent label that matches the work (infra/docs-only/feature/change-ops/platform/recovery). Historical `codex` intent remains for old PRs only.
