 ...
 */
async function buildRenditionPayload(mediaId: number, url: string): Promise<{ ok: true; items: RenditionPayloadItem[] } | { ok: false; error: string }> {
...
export function RenditionGenerationControl(props: { storyId: number; mediaId: number; url?: string | null; onStatus: (message: string) => void; actionsEnabled: boolean }) {
