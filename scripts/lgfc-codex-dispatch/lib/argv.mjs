/**
 * Strict argv parsing for LGFC Codex dispatch (#4052).
...
export function buildIdentifiersOnlyPrompt({ repo, issueNumber, event, deliveryId, runId }) {
  return [
    ...
    'Load Agent.md, docs/ops/ai/CODEX-RULES.md, and the mandatory documentation chain, then fetch the live GitHub source Issue state.',
    'Verify assignment (`agent:codex`), handoff readiness, allowlist, and Implementation Go before any mutation.',
